    ...
    <div className="crate-event">
        ...
        <div className="create-event-body ">
            ...
            onSubmit= {handleSubmit} >
                <label>
                    <input type="mt-3 text" className="form-control" placeholder={location.state.name}
                        onChange={
                            e => setName(e.target.value)
                        }/>
                </label>
                <label>
                    <textarea rows="5" cols="60" type="text" className="mt-2 form-control" placeholder={location.state.description}
                        onChange={
