...
import {AdminNav, Event, Club, AdminClub} from "../../../Components"
    ...
    return (
        <div className="st-body-grid">
            ...
            <div className="dflex m-3 d-flex justify-content center">
                <div className="mt-3 searchbox"> 
                    <input type="clubname" className="search-club" name="" placeholder="Search Club"/> 
                </div>
                <button onClick={()=>{history.push("/createclub")}} 
                    className="btn btn-primary btn-block create_club">Create Club</button> 
            </div>
            </div>
            </div>
            ...
            <div className="container">
                <div className="row">
                    <div className="profile_clubs col-lg-25">
                        {
                        clubs.map((club) => (
                            <AdminClub name={
                                    club.name
